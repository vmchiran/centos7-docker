...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "dkr" do |machine|
    ...
    machine.vm.provision "ansible_local" do |ansible|
      ...
      # Default inventory file generated for ansible_local is:
      # ansible.inventory_path = "/tmp/vagrant-ansible/inventory/vagrant_ansible_local_inventory/vagrant_ansible_local_inventory"
      # You may set a different path, which is by default relative to the ansible.provisioning_path
